...
def main(args):
    ...
    print("data_loader_train", data_loader_train, "sampler_train", sampler_train)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'SwiftFormer training and evaluation script', parents=[get_args_parser1()])
    ...
    args.data_set = 'CIFAR'
    args.data_path = '/home/scs/mydatasets/cifar/cifarpython'
    #args.data_path = '/datasets/ILSVRC2012'
    #args.data_set = 'IMNET200'
    #args.data_path = '/home/scs/mydatasets/tiny-imagenet-200'

    args.distillation_type = 'none'
    
    args.output_dir = '/home/scs/mydatasets/tiny-imagenet-200-out'
    args.aa = ''
    args.mixup = 0.0
    args.cutmix = 0.0
    args.word_size = 4
